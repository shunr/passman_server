...
import (
	...
	"flag"
	"fmt"
	"github.com/shunr/passman_server/db"
	pb "github.com/shunr/passman_server/proto"
...
type passmanServer struct {
}

func (s passmanServer) CreateAccount(ctx context.Context, request *pb.CreateAccountRequest) (*pb.CreateAccountResponse, error) {
...
func main() {
	...
	pb.RegisterPassmanServer(grpcServer, newServer())
